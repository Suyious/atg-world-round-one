import { Button, ButtonGroup, Container, Dropdown, DropdownButton, Nav } from "react-bootstrap";
import "./Body.css";
          ...
          <div className="sub_navigation">
            ...
            <ButtonGroup className="sub_nav_buttons">
              ...
              <div className="sub_nav_button join_group">
                {(!loginStatus || !groupJoin)?<Button className="join" onClick={()=>setOpenModal(true)}>
